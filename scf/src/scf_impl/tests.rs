...
use super::{SCF, SimpleSCF, SpinSCF};
    ...
    fn test_h2_singlet_vs_triplet() {
        ...
        assert!(
            ...
            expected_h2_energy_approx, triplet_energy
        );
        ...
        println!("  Singlet energy: {:.6} hartree (incorrect due to UHF limitation)", singlet_energy);
