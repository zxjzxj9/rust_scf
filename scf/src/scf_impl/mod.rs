//! SCF calculation implementations
//!
//! This module contains the SCF trait definition, DIIS implementation,
//! and various SCF algorithm implementations.
