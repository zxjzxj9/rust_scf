...
fn main() {
    ...
    for step in 0..total_steps {
        ...
        if step % output_interval == 0 {
            ...
            println!(
                "│ {:>6} │ {:>7.3} │ {:>9.3} │ {:>9.3} │ {:>8.3} │ {:>8.3} │ {:>8.4} │",
                step, current_temp, current_pressure, target_pressure, volume, box_x, kinetic
            );
        }
    }
